...
private fun PermissionRationale(onClose: () -> Unit) {
    Surface(Modifier.fillMaxSize()) {
        Column(
            ...
            Text(
                "HealthIA Bridge solo lee los tipos de Health Connect que autorizas. " +
                    "Envía cada registro al servidor HealthIA que tú indiques y conserva su procedencia, " +
                    "fecha y dispositivo de origen."
            )
            Text(
